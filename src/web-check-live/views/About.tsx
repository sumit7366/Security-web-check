...
const About = (): JSX.Element => {
  return (
    ...
    <AboutContainer>
      <Nav>
        <HeaderLinkContainer>
          <a target="_blank" rel="noreferrer" href="https://github.com/sumit7366/Security-web-check"><Button>View on GitHub</Button></a>
        </HeaderLinkContainer>
      </Nav>
      ...
      <Section>
        ...
        <hr />
        <p>
          Security-Web-Check is developed and maintained by <a target="_blank" rel="noreferrer" href="https://github.com/sumit7366/Security-web-check">Sumit kumar</a>.
          It's licensed under the <a target="_blank" rel="noreferrer" href="https://github.com/sumit7366/Security-web-check">MIT license</a>,
          and is completely free to use, modify and distribute in both personal and commercial settings.<br />
          Source code and self-hosting docs are available on <a target="_blank" rel="noreferrer" href="https://github.com/sumit7366/Security-web-check">GitHub</a>.
          If you've found this service useful, consider <a target="_blank" rel="noreferrer" href="https://github.com/sumit7366/Security-web-check">sponsoring me</a> from $1/month,
      ...
      <Section>
        ...
        <a target="_blank" rel="noreferrer" href="https://app.netlify.com/start/deploy?repository=https://github.com/sumit7366/Security-web-check">
        ...
        <a target="_blank" rel="noreferrer" href="https://vercel.com/new/import/git?repository-url=https://https://github.com/sumit7366/Security-web-check">
          <img src="https://vercel.com/button" alt="Deploy with Vercel" />
        </a>

        <Heading as="h3" size="small" color={colors.primary}>Option #3 - Docker</Heading>
        <p>
        A Docker container is published to <a target="_blank" rel="noreferrer" href="https://github.com/sumit7366/Security-web-check">DockerHub</a>
        <br />
        Run this command, then open <code>localhost:3000</code>
        <pre>docker run -p 3000:3000 sumit7366/security-web-cheker</pre>
        </p>

        <Heading as="h3" size="small" color={colors.primary}>Option #4 - Manual</Heading>
        <pre>
        git clone https://github.com/sumit7366/Security-web-check<br />
        ...
        yarn dev # Start the app (API and GUI)<br />
        </pre>
        ...
        <p>
          ...
          GitHub repository - <a target="_blank" rel="noreferrer" href="https://github.com/sumit7366/Security-web-check#readme">sumit7366/Security-web-check</a>
        </p>
      ...
      <Heading as="h3" size="small" color={colors.primary}>License</Heading>
        <b>
          <a target="_blank" rel="noreferrer" href="https://github.com/sumit7366/Security-web-check">Web-Check</a> is licensed under the MIT License.
          © <a target="_blank" rel="noreferrer" href=".  ">Cyber security</a> { new Date().getFullYear()}
        </b>
        <br />
